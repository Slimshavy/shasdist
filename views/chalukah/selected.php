...
<div class="distribution-profile-selected">
    ...
    <h1><?= $this->title ?></h1>
    <h3>Sorry, <?= ucfirst($model->user->firstname) ?>! Mesechtos <?= $model->mesechtaEnglishName ?> is already taken. Please return to <?= Html::a($model->distributionprofile->header,['index','profilename'=>$model->distributionprofile->profilename]) ?> profile page and select another mesechta. <br/></br>Thank You!
